...
public class PlayerActivity extends AppCompatActivity
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dataSourceFactory = VideoUtil.getDataSourceFactory(/* context= */ this);
    ...
    private MediaSource.Factory createMediaSourceFactory() {
        ...
        drmSessionManagerProvider.setDrmHttpDataSourceFactory(VideoUtil.getHttpDataSourceFactory(/* context= */ this));
    ...
    private void setRenderersFactory(ExoPlayer.Builder playerBuilder, boolean preferExtensionDecoders) {
        RenderersFactory renderersFactory = VideoUtil.buildRenderersFactory(/* context= */ this, preferExtensionDecoders);
    ...
    private List<MediaItem> createMediaItems(Intent intent) {
        ...
        List<MediaItem> mediaItems = createMediaItems(intent, VideoUtil.getDownloadTracker(/* context= */ this));
