package android.lib.player.download;
...
import android.lib.player.TrackSelectionDialog;
...
public class VideoDownloadTracker {
    ...
    public VideoDownloadTracker(Context context, DataSource.Factory dataSourceFactory, DownloadManager downloadManager) {
    ...
    public void toggleDownload(
        ...
        if (download != null && download.state != Download.STATE_FAILED) {
            ...
            startDownloadDialogHelper = new StartDownloadDialogHelper(fragmentManager,
                    DownloadHelper.forMediaItem(context, mediaItem, renderersFactory, dataSourceFactory), mediaItem);
        }
    }
    ...
    private final class StartDownloadDialogHelper
        ...
        private void startDownload(DownloadRequest downloadRequest) {
            DownloadService.sendAddDownload(context, VideoDownloadService.class, downloadRequest, /* foreground= */ false);
        }
