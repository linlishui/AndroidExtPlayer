...
import static android.lib.player.util.VideoUtil.DOWNLOAD_NOTIFICATION_CHANNEL_ID;
...
public class VideoDownloadService extends DownloadService {
    ...
    protected DownloadManager getDownloadManager() {
        ...
        DownloadManager downloadManager = VideoUtil.getDownloadManager(/* context= */ this);
        DownloadNotificationHelper downloadNotificationHelper = VideoUtil.getDownloadNotificationHelper(/* context= */ this);
    ...
    protected Notification getForegroundNotification(List<Download> downloads, @Requirements.RequirementFlags int notMetRequirements) {
        return VideoUtil.getDownloadNotificationHelper(/* context= */ this)
