package android.lib.player.util;
...
import android.lib.player.BuildConfig;
...
public final class VideoUtil {
    ...
    private static synchronized void ensureDownloadManagerInitialized(Context context) {
        if (downloadManager == null) {
            ...
            downloadTracker = new VideoDownloadTracker(context, getHttpDataSourceFactory(context), downloadManager);
        }
    }
