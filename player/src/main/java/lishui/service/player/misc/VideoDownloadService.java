...
import static lishui.service.player.misc.VideoUtils.DOWNLOAD_NOTIFICATION_CHANNEL_ID;
...
import lishui.service.player.R;
...
public class VideoDownloadService extends DownloadService {
    ...
    protected DownloadManager getDownloadManager() {
        ...
        DownloadManager downloadManager = VideoUtils.getDownloadManager(/* context= */ this);
        DownloadNotificationHelper downloadNotificationHelper =
                VideoUtils.getDownloadNotificationHelper(/* context= */ this);
    ...
    protected Notification getForegroundNotification(@NonNull List<Download> downloads) {
        return VideoUtils.getDownloadNotificationHelper(/* context= */ this)
