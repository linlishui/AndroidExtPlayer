package lishui.service.player.misc;
...
import lishui.service.player.BuildConfig;
import lishui.service.player.ext.CronetDataSource;
import lishui.service.player.ext.CronetEngineWrapper;
...
public final class VideoUtils {
    ...
    private static VideoDownloadTracker downloadTracker;
    ...
    public static synchronized HttpDataSource.Factory getHttpDataSourceFactory(Context context) {
        if (httpDataSourceFactory == null) {
            if (USE_CRONET_FOR_NETWORKING) {
                ...
                CronetEngineWrapper cronetEngineWrapper = new CronetEngineWrapper(
                        context, USER_AGENT, /* preferGMSCoreCronet= */ false);
                httpDataSourceFactory = new CronetDataSource.Factory(
    ...
    public static synchronized DownloadNotificationHelper getDownloadNotificationHelper(
        ...
        if (downloadNotificationHelper == null) {
            downloadNotificationHelper = new DownloadNotificationHelper(
    ...
    private static synchronized void ensureDownloadManagerInitialized(Context context) {
        if (downloadManager == null) {
            ...
            downloadTracker =
                    new VideoDownloadTracker(context, getHttpDataSourceFactory(context), downloadManager);
        }
    }
